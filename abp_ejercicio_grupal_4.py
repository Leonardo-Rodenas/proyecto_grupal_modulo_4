...
vendedor1 = Vendedor("Manuel", "Gutierrez", "17.125.489-k", "Chaqueta")
vendedor2 = Vendedor("Sofía", "Perez", "13.213.489-5", "Zapatillas")
vendedor3 = Vendedor("Elizabeth", "Erazo", "12.147.789-6", "Guantes")
vendedor4 = Vendedor("Karen", "Smith", "16.236.478-5", "Zapatos")
vendedor5 = Vendedor("Carlos", "Pacheco", "10.456.147-k", "Polerón")
